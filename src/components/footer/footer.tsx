...
export const Footer: React.FC<FooterProps> = ({
  ...
  className,
  variant = 'default',
  backgroundColor = 'bg-pallete-gold',
  ...
  const renderFooterContent = () => {
    switch (variant) {
      case 'minimal':
        return (
          <div
            className={`container mx-auto flex justify-center items-center ${fontMontserrat.className} font-normal text-lg tracking-wide text-center text-wrap`}
          >
            <TextHeading level={6} className='px-4 text-center'>
              {powerBy}
            </TextHeading>
          </div>
        );
